...
describe('UTILS', () => {
  ...
  describe('Dimensions', async () => {
    it('.getDimensions', async () => {
      ...
      sandbox.stub(axios, 'get').returns(resolved)
      const result = await utils.getDimensions(layerMetadata)
      assert.deepEqual(result, ['2000-01-01T00:00:00.000Z', '2001-01-01T00:00:00.000Z', '2002-01-01T00:00:00.000Z', '2003-01-01T00:00:00.000Z', '2004-01-01T00:00:00.000Z', '2005-01-01T00:00:00.000Z', '2006-01-01T00:00:00.000Z', '2007-01-01T00:00:00.000Z', '2008-01-01T00:00:00.000Z', '2009-01-01T00:00:00.000Z', '2010-01-01T00:00:00.000Z', '2011-01-01T00:00:00.000Z', '2012-01-01T00:00:00.000Z', '2013-01-01T00:00:00.000Z', '2014-01-01T00:00:00.000Z', '2015-01-01T00:00:00.000Z', '2016-01-01T00:00:00.000Z', '2017-01-01T00:00:00.000Z', '2018-01-01T00:00:00.000Z'])
    })
    ...
    it('.splitDimensions', () => {
      ...
      const result = utils.splitDimensions(dimensions)
      assert.deepEqual(result, ['2000-01-01T00:00:00.000Z', '2001-01-01T00:00:00.000Z', '2002-01-01T00:00:00.000Z', '2003-01-01T00:00:00.000Z', '2004-01-01T00:00:00.000Z', '2005-01-01T00:00:00.000Z', '2006-01-01T00:00:00.000Z', '2007-01-01T00:00:00.000Z', '2008-01-01T00:00:00.000Z', '2009-01-01T00:00:00.000Z', '2010-01-01T00:00:00.000Z', '2011-01-01T00:00:00.000Z', '2012-01-01T00:00:00.000Z', '2013-01-01T00:00:00.000Z', '2014-01-01T00:00:00.000Z', '2015-01-01T00:00:00.000Z', '2016-01-01T00:00:00.000Z', '2017-01-01T00:00:00.000Z', '2018-01-01T00:00:00.000Z'])
    })
  })
})
